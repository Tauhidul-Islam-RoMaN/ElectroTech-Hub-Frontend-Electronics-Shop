    ...
    return (
        ...
        <>
            <div className="mx-10 rounded-2xl my-10">
                <div className="lg:h-[750px] text-white text-center md:h-[460px]  grid h-[160px] bg-contain lg:bg-cover bg-no-repeat bg-[url('https://i.ibb.co/zG6BC5y/banner-1.jpg')] mb-8">
