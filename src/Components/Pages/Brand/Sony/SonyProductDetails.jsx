...
const SonyProductDetails = ({sonyProducts}) => {
    const { brand, name, photo, price, description, rating, type,_id } = sonyProducts
...
SonyProductDetails.propTypes = {
    sonyProducts: PropTypes.object
};

export default SonyProductDetails;