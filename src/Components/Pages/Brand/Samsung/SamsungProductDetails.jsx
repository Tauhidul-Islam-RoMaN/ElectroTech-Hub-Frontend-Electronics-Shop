...
const SamsungProductDetails = ({samsungProducts}) => {
    
    const { brand, name, photo, price, description, rating, type,_id } = samsungProducts
...
SamsungProductDetails.propTypes = {
    samsungProducts: PropTypes.object
}
